...
public class EventBusRabbitMQ : BaseEventBus
{
    ...
    public EventBusRabbitMQ(EventBusConfig config, IServiceProvider serviceProvider) : base(config, serviceProvider)
    {
        if (EventBusConfig.Connection != null)
        {
            ...
            else
            {
                ...
                //var connJson = JsonSerializer.Serialize(EventBusConfig.Connection, new JsonSerializerSettings()
                //{
    ...
    public override void Publish(IntegrationEvent @event)
    {
        ...
        consumerChannel.ExchangeDeclare(exchange: EventBusConfig.DefaultTopicName, ExchangeType.Direct); // Ensure exchange exists while publishing
